          ...
          <div className="max-w-4xl mx-auto space-y-8 text-foreground">
            ...
            <section>
              ...
              <div className="space-y-5 text-muted-foreground leading-relaxed">
                <p><strong className="text-foreground">Reichweitenmessung:</strong> Mit Ihrer Einwilligung laden wir Umami, um aggregierte Nutzungsstatistiken auszuwerten und Inhalte zu verbessern. Dabei erfassen wir bei der Auswahl einer Erlebnis-Kategorie ausschließlich die gewählte Kategorie und die Platzierung des Einstiegs (mobil oder Desktop). Bei bewussten Ticketklicks erfassen wir ausschließlich Musicalkennung, Partner und CTA-Platzierung, um Ticketwege zu verbessern. Ticket-, Standort-, URL- und sonstige personenbezogene Daten werden hierfür nicht übermittelt.</p>
                <p><strong className="text-foreground">Partner- und Affiliate-Messung:</strong> Mit Ihrer Einwilligung laden wir native Kampagnenbilder und zugehörige Impressionpixel erst, wenn das jeweilige Werbemittel sichtbar wird. Ticket- und Angebotslinks enthalten die bereitgestellten direkten Affiliate-Trackingziele; beim bewussten Klick werden Sie zum jeweiligen Partner weitergeleitet. Globale Awin- oder TradeDoubler-Fremdskripte werden nicht geladen.</p>
