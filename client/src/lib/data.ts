...
export const musicals: Musical[] = [
  ...
  },
  {
    ...
    tourDates: [
      ...
      { city: "Gera", venue: "Kultur- und Kongresszentrum", startDate: "2026-12-07", endDate: "2026-12-08", eventimUrl: "https://www.eventim.de/artist/drei-haselnuesse-fuer-aschenbroedel/" },
    ...
    faqItems: [
      ...
      { question: "Wo sind Tickets erhältlich?", answer: "Tickets sind online über Eventim und Öticket erhältlich." },
