...
export const musicals: Musical[] = [
  ...
  },
  {
    ...
    venue: "Stage Palladium Theater",
    cities: ["Stuttgart"],
    description: "& JULIA – Das Pop-Musical mit 24 Nummer-1-Hits im Stage Palladium Theater Stuttgart. Roar, Can't Stop The Feeling, Perfect und viele mehr. Tickets ab 45,49 €.",
    ...
    seoTitle: "& JULIA – Das Pop-Musical Stuttgart 2026 | Tickets ab 45,49 €",
