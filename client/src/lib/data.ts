...
export const musicals: Musical[] = [
  ...
  },
  {
    ...
    storyHeadline: "CHAOS, HERZ UND JEDE MENGE LACHER",
    storyText: "Zeki Müller hat einen Plan: Er will die Beute aus seinem letzten Coup aus dem Schulhof der Goethe-Gesamtschule ausgraben. Doch der Plan geht schief – und er landet versehentlich als Aushilfslehrer in der berüchtigten Klasse 10b. Die ist bekannt für ihren Hang zum Chaos und dafür, Lehrer in den Wahnsinn zu treiben.\n\nDort trifft er auf die idealistisch-naive Lehrerin Lisi Schnabelstedt, die an das Gute in jedem Schüler glaubt. Was als Zweckgemeinschaft beginnt, entwickelt sich zu einer unerwarteten Freundschaft – und vielleicht zu mehr. Denn hinter Zekis rauem Auftreten verbirgt sich ein Herz, das niemand erwartet hätte. Kann die chaotische Klasse 10b doch noch gerettet werden?",
    faqItems: [
      { question: "Wo wird das Musical gespielt?", answer: "Das Musical gastiert an verschiedenen Spielstätten in Deutschland und Österreich." },
      { question: "Wo sind Tickets erhältlich?", answer: "Tickets sind online über Eventim und Oeticket erhältlich." },
