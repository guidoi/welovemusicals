...
export const musicals: Musical[] = [
...

  {
    ...
    uspItems: [
      ...
      { icon: "MapPin", title: "Deutschlandtournee 2027", text: "Live in Duisburg, München, Berlin und weiteren Städten" },
    ...
    seoDescription: "Rapunzel – Das Märchenhafte Musical auf Deutschlandtournee 2027: Duisburg, München, Köln, Frankfurt, Bremen, Berlin und mehr. Jetzt Tickets für die ganze Familie sichern!",
    tourDates: [
      ...
      { city: "Berlin", venue: "BlueMax Theater", startDate: "2027-05-14", endDate: "2027-06-06", eventimUrl: "https://www.awin1.com/cread.php?awinmid=11388&awinaffid=2865727&clickref=rapunzel-berlin-dates&ued=https%3A%2F%2Fwww.eventim.de%2Fartist%2Frapunzel-das-maerchenhafte-musical%2F%3Fcityname%3DBerlin" },
    ],
    showFacts: [
      { label: "Showdauer", value: "ca. 2 Stunden 15 Minuten (inkl. Pause)" },
      { label: "Sprache", value: "Alle Dialoge und Songs in deutscher Sprache" },
      { label: "Auf Tour", value: "März bis Juni 2027" },
      { label: "Altersempfehlung", value: "Ab 6 Jahren" },
    ],
    ...
    faqItems: [
      ...
      { question: "Wo wird das Musical gespielt?", answer: "Das Musical gastiert 2027 an sechs Spielstätten: im Theater am Marientor in Duisburg, im Deutschen Theater in München, in der Motorworld Köln, in der myticket Jahrhunderthalle Frankfurt, im Metropol Theater Bremen und im BlueMax Theater Berlin." },
...

  {
    ...
    keyvisualLink: "https://www.atgtickets.de/musicals-shows/gloeckner-von-notre-dame/tickets/",
...

  {
    ...
    awinStickyUrl: KOENIG_DER_LOEWEN_STAGE_TEXT_LINK_URL,
    awinBoxUrl: KOENIG_DER_LOEWEN_STAGE_TEXT_LINK_URL,
    featured: true,
...

  {
    ...
    cities: ["Hamburg"],
    description: "MJ – Das Michael Jackson Musical in Hamburg: Erlebe die legendären Moves und Welthits des King of Pop live auf der Bühne. Tony Award-prämierte Produktion im Stage Theater an der Elbe. Tickets ab 56,99 €.",
    ...
    showFacts: [
      ...
      { label: "Altersempfehlung", value: "Ab 6 Jahren" },
      { label: "Tickets ab", value: "56,99 € (bei Stage Entertainment)" },
    ],
    seoTitle: "MJ – Das Michael Jackson Musical Hamburg 2026/2027 | Tickets & Infos",
    seoDescription: "MJ – Das Michael Jackson Musical im Stage Theater an der Elbe Hamburg. Tickets ab 56,99 €. Über 25 Welthits live – Thriller, Billie Jean, Smooth Criminal. Tony Award-prämiert!",
    ...
    faqItems: [
      ...
      { question: "Wie viel kosten die Tickets?", answer: "Tickets sind ab 56,99 € erhältlich. Die Preise variieren je nach Kategorie und Vorstellungsdatum." },
  ...
  },
  {
    ...
    awinStickyUrl: TARZAN_STAGE_TEXT_LINK_URL,
    awinBoxUrl: TARZAN_STAGE_TEXT_LINK_URL,
  ...
  },
  {
    ...
    awinStickyUrl: ZIZ_STAGE_TEXT_LINK_URL,
    awinBoxUrl: ZIZ_STAGE_TEXT_LINK_URL,
  ...
  },
  {
    ...
    awinStickyUrl: PRADA_STAGE_TEXT_LINK_URL,
    awinBoxUrl: PRADA_STAGE_TEXT_LINK_URL,
  ...
  },
  {
    ...
    ticketCtaUrl: WIR_SIND_AM_LEBEN_STAGE_TEXT_LINK_URL,
    awinHeroUrl: WIR_SIND_AM_LEBEN_STAGE_TEXT_LINK_URL,
  ...
  },
  {
    ...
    awinStickyUrl: TANZ_DER_VAMPIRE_STAGE_TEXT_LINK_URL,
    awinBoxUrl: TANZ_DER_VAMPIRE_STAGE_TEXT_LINK_URL,
  ...
  },
  {
    ...
    awinStickyUrl: SALON_ROSIE_STAGE_TEXT_LINK_URL,
    awinBoxUrl: SALON_ROSIE_STAGE_TEXT_LINK_URL,
  ...
  },
  {
    ...
    awinStickyUrl: UND_JULIA_STAGE_TEXT_LINK_URL,
    awinBoxUrl: UND_JULIA_STAGE_TEXT_LINK_URL,
  ...
  },
  {
    ...
    awinStickyUrl: TINA_STAGE_TEXT_LINK_URL,
    awinBoxUrl: TINA_STAGE_TEXT_LINK_URL,
    ...
    tourDates: [
      { city: "Hamburg", venue: "Stage Operettenhaus", startDate: "2027-04-06", eventimUrl: TINA_STAGE_TEXT_LINK_URL, displayLabel: "Ab April 2027" },
    ],
    gallery: [
