...
describe("getHeroNavigationItems", () => {
  it("stellt Orientierungstabs, kuratierte Top-Musicals und einen A–Z-Einstieg bereit", () => {
    ...
    expect(items).toEqual([
      ...
      { id: "category-familie-maerchen-magie", label: "Familie & Märchen", href: "/?erlebnis=familie-maerchen-magie#more-musicals", kind: "category", categoryId: "familie-maerchen-magie" },
      { id: "category-besondere-geschichten", label: "Drama & Komödie", href: "/?erlebnis=besondere-geschichten#more-musicals", kind: "category", categoryId: "besondere-geschichten" },
