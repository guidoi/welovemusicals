...
describe("getHeroNavigationItems", () => {
  it("stellt Orientierungstabs, kuratierte Top-Musicals und einen A–Z-Einstieg bereit", () => {
    ...
    expect(items).toEqual([
      ...
      { id: "category-blockbuster-spektakel", label: "Blockbuster", href: "/?erlebnis=blockbuster-spektakel#more-musicals", kind: "category", categoryId: "blockbuster-spektakel" },
      { id: "category-kult-klassiker", label: "Kult & Klassiker", href: "/?erlebnis=kult-klassiker#more-musicals", kind: "category", categoryId: "kult-klassiker" },
      { id: "category-pop-rock-filmhits", label: "Pop, Rock & Film", href: "/?erlebnis=pop-rock-filmhits#more-musicals", kind: "category", categoryId: "pop-rock-filmhits" },
      { id: "category-familie-maerchen-magie", label: "Familie, Märchen & Magie", href: "/?erlebnis=familie-maerchen-magie#more-musicals", kind: "category", categoryId: "familie-maerchen-magie" },
      { id: "category-besondere-geschichten", label: "Besondere Geschichten", href: "/?erlebnis=besondere-geschichten#more-musicals", kind: "category", categoryId: "besondere-geschichten" },
