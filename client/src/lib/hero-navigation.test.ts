...
describe("getHeroNavigationItems", () => {
  it("stellt Orientierungstabs, kuratierte Top-Musicals und einen A–Z-Einstieg bereit", () => {
    ...
    expect(items).toEqual([
      ...
      { id: "category-besondere-geschichten", label: "Drama & Emotion", href: "/?erlebnis=besondere-geschichten#more-musicals", kind: "category", categoryId: "besondere-geschichten" },
