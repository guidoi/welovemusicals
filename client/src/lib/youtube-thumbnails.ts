...
export const trailerThumbnailByVideoId: Record<string, string> = {
  ...
  "9LJMaLj8Ino": "/images/show-visuals/trailer-thumbnails/sister-act-scene.webp",
  B0vHUyLx2Ac: "/images/show-visuals/trailer-thumbnails/fack-ju-goehte-scene.jpg",
  IWrg3s9gMsY: "/images/show-visuals/trailer-thumbnails/gloeckner-scene.webp",
  ...
  "-N3CbbBAyMM": "/images/show-visuals/trailer-thumbnails/tarzan-scene.jpg",
  ...
  "9zPIQ43Iwwc": "/images/show-visuals/trailer-thumbnails/tanz-der-vampire-scene.jpg",
...
/**
 * Diese Vorschauen verwenden bewusst Bühnen- oder Szenenbilder statt Artwork.
 * Auch bei künftigen Trailern ist ein passendes Szenenmotiv zu bevorzugen.
 */
export const sceneThumbnailVideoIds = new Set([
  "9LJMaLj8Ino",
  "B0vHUyLx2Ac",
  "IWrg3s9gMsY",
  "-N3CbbBAyMM",
