    ...
    <section className="py-16 px-4 bg-background">
      <div className="container max-w-6xl">
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scroll("left")}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-accent hover:bg-accent/80 text-accent-foreground rounded-full p-2 transition-colors duration-200 z-10"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-accent hover:bg-accent/80 text-accent-foreground rounded-full p-2 transition-colors duration-200 z-10"
