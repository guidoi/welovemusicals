  ...
  },
  {
    ...
    creatives: {
      wide: createAwinCreative({
        ...
        merchantId: "111888",
        queryId: "597568",
        imageUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663510091225/UgTcyxPlEFQcQEfj.jpg",
        width: 728,
        height: 90,
      }),
      square: createAwinCreative({
        ...
        merchantId: "111888",
        queryId: "597568",
        imageUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663510091225/LLbYiHYYucAcIsfS.jpg",
        width: 600,
        height: 600,
      }),
    },
  },
  {
    ...
    creatives: {
      wide: createAwinCreative({
        ...
        merchantId: "111888",
        queryId: "508544",
        imageUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663510091225/cNjssQMFzIxxObAw.jpg",
        width: 728,
        height: 90,
      }),
      square: createAwinCreative({
        ...
        merchantId: "111888",
        queryId: "508544",
        imageUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663510091225/aVLvtLqeZGZpSyOm.jpg",
        width: 320,
        height: 480,
      }),
    },
  },
  {
    ...
    creatives: {
      wide: createAwinCreative({
        ...
        merchantId: "11388",
        queryId: "492097",
        imageUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663510091225/ofkQWvwvsFFYcItR.jpg",
        width: 728,
        height: 90,
      }),
      square: createAwinCreative({
        ...
        merchantId: "11388",
        queryId: "492097",
        imageUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663510091225/GDrhbvoacicMlOjP.jpg",
        width: 300,
        height: 250,
      }),
    },
  },
  {
    ...
    creatives: {
      wide: createAwinCreative({
        ...
        merchantId: "11388",
        queryId: "492097",
        imageUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663510091225/kXTJLZsyeoxkPzcT.jpg",
        width: 728,
        height: 90,
      }),
      square: createAwinCreative({
        ...
        merchantId: "11388",
        queryId: "492097",
        imageUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663510091225/NnlhNtybfKuJEoGP.jpg",
        width: 300,
        height: 250,
      }),
    },
    ...
    >
      ...
      <button
        ...
        onClick={() => {
          ...
          window.open(creative.clickUrl, "_blank", "noopener");
        }}
